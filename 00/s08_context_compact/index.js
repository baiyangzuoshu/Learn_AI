      ...
      function: {
        ...
        parameters: {
          ...
          properties: {
            pattern: {
              type: "string",
              description: "Glob pattern such as **/*.js or s08_context_compact/*.md.",
            },
          },
          required: ["pattern"],
        },
...
async function main() {
  console.log("s08: Context Compact (Node.js + DeepSeek)");
  ...
  while (true) {
    const query = await terminal.question("\x1b[36ms08 >> \x1b[0m");
